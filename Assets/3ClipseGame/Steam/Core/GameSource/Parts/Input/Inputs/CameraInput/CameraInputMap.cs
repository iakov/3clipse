...
//     version 1.4.2
//     from Assets/3ClipseGame/Steam/Core/GameSource/Parts/Input/Inputs/CameraInput/CameraInputMap.inputactions
//
...
public partial class @CameraInputMap : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @CameraInputMap()
    {
    ...
    {
        private @CameraInputMap m_Wrapper;
        public MouseMapActions(@CameraInputMap wrapper) { m_Wrapper = wrapper; }
