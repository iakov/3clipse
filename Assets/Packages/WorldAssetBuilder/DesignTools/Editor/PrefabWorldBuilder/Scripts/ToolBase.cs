...
namespace PluginMaster
{
        ...
        where TOOL_SETTINGS : IToolSettings, new()
    {
        ...
        private static Dictionary<string, TOOL_SETTINGS> _staticProfiles = new Dictionary<string, TOOL_SETTINGS>
        ...
        ISerializationCallbackReceiver, ICloneableToolSettings
    {
        ...
        public bool parallelToTheSurface
        {
    ...
    {
        #region ID
        private static long _nextId = DateTime.Now.Ticks;
        ...
        #endregion
        #region OBJECT POSES
        [SerializeField] protected List<ObjectPose> _objectPoses = new List<ObjectPose>();
        ...
        [SerializeField] protected List<CONTROL_POINT> _controlPoints = new List<CONTROL_POINT>();
        ...
        where TOOL_DATA : PersistentData<TOOL_NAME, TOOL_SETTINGS, CONTROL_POINT>, new()
    {
        ...
        [SerializeField] private List<TOOL_DATA> _items = null;
        ...
        {
            if (_items == null) _items = new List<TOOL_DATA>();
            _items.Add(data);
        }
