...
namespace PluginMaster
{
    public class BrushProperties : EditorWindow, ISerializationCallbackReceiver
    {
        ...
        private void OnGUI()
        {
            ...
            if (_itemAdded)
            {
                if (PWBCore.staticData.undoBrushProperties) Undo.RegisterCompleteObjectUndo(this, "Add Brush Item");
                ...
                false, false, GUI.skin.horizontalScrollbar, GUI.skin.verticalScrollbar, GUIStyle.none))
            {
                ...
                if (showBrushGroup)
                {
                    if (PaletteManager.selectedBrush.items.Length == 0)
                    {
                        ...
                        if (PWBCore.staticData.undoBrushProperties) Undo.RegisterCompleteObjectUndo(this, "Delete Brush");
            ...
            BrushSettings brushSelectionSettings, BrushSelectionState brushSelectionState)
        {
            using (new GUILayout.HorizontalScope())
            {
                ...
                if (GUILayout.Button("Apply"))
                {
                    ...
                    {
                        if (PWBCore.staticData.undoBrushProperties) Undo.RegisterCompleteObjectUndo(this, undoMsg);
            ...
            UnityEngine.Object objToUndo, string undoMsg)
        {
            ...
            using (var check = new EditorGUI.ChangeCheckScope())
            {
                ...
                {
                    changed = true;
                    if (PWBCore.staticData.undoBrushProperties) Undo.RegisterCompleteObjectUndo(objToUndo, undoMsg);
        ...
        private void PasteThumbnailSettings(object idx)
        {
            ...
            if (PWBCore.staticData.undoBrushProperties) Undo.RegisterCompleteObjectUndo(this, "Paste Thumbnail Settings");
        ...
        {
            var idx = (int)obj;
            if (PWBCore.staticData.undoBrushProperties) Undo.RegisterCompleteObjectUndo(this, "Delete Brush Item");
