...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        private static void GravityToolDuringSceneGUI(SceneView sceneView)
        {
            ...
            if (MouseRaycast(mouseRay, out RaycastHit hit, out GameObject c,
                ...
                && (Event.current.type == EventType.MouseDown || Event.current.type == EventType.MouseDrag))
            {
                ...
                foreach (var item in _paintStroke)
                {
                    ...
                    if (PrefabUtility.GetPrefabAssetType(item.prefab) == PrefabAssetType.Model) continue;
                ...
                foreach (var meshCol in meshColliders) UnityEngine.Object.DestroyImmediate(meshCol, true);
                AssetDatabase.Refresh();
                ...
                foreach (var obj in paintedObjects)
                {
                    ...
                    foreach (var collider in colliders)
                    {
                        ...
                        if (PrefabUtility.IsAddedComponentOverride(collider))
                            PrefabUtility.RevertAddedComponent(collider, InteractionMode.AutomatedAction);
                    }
