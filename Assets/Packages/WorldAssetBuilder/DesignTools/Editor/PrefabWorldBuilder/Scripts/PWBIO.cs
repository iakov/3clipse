...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        public static void DuringSceneGUI(SceneView sceneView)
        {
            ...
            if (Event.current.control && Event.current.type == EventType.KeyDown && Event.current.keyCode == KeyCode.Space)
            {
                switch (tool)
                {
        ...
        private static void BrushstrokeMouseEvents(BrushToolBase settings)
        {
            ...
            else if (Event.current.type == EventType.KeyUp && Event.current.control && Event.current.keyCode == KeyCode.Space)
            {
                BrushstrokeManager.UpdateBrushstroke();
                repaint = true;
            }
        ...
        private static void PaletteInput(SceneView sceneView)
        {
            ...
            if (Event.current.isScrollWheel && Event.current.capsLock)
            {
                Event.current.Use();
