...
namespace PluginMaster
{
    public static class BoundsUtils
    {
        ...
        public static Bounds GetBounds(Transform transform, ObjectProperty property = ObjectProperty.BOUNDING_BOX)
        {
            ...
            if (_boundsDictionary.ContainsKey(key)) return _boundsDictionary[key];
        ...
        private static Dictionary<(int, ObjectProperty), Bounds> _boundsRecursiveDictionary
            = new Dictionary<(int, ObjectProperty), Bounds>();
            ...
            ObjectProperty property = ObjectProperty.BOUNDING_BOX)
        {
            ...
            var key = (transform.gameObject.GetInstanceID(), property);
            if (_boundsRecursiveDictionary.ContainsKey(key)) return _boundsRecursiveDictionary[key];
